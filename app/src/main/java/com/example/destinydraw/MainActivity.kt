...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(s: Bundle?) {
        ...
        binding.btnFortune.startAnimation(pulseAnimation)
    ...
    private val cardSelectionLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
